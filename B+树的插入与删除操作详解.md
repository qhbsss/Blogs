# 多路查找树：B+树的插入与删除操作详解
B+树有人理解为B树的升级，有人理解为B树的变形（变体），都可以。性质上来看，B+树与B树基本相同，但还是有一些不同点的。
...
![image-20240831123221593](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123221593.png)
...
![image-20240831123231582](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123231582.png)
...
![image-20240831123242585](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123242585.png)
...
![image-20240831123257339](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123257339.png)

- 插入1，放到2、3所在的节点中，注意顺序，现在1、2、3在一个节点中。
- 插入9，放到6、7所在的节点中，注意顺序，现在6、7、9在一个节点，如图5所示：

![image-20240831123308411](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123308411.png)

- 插入8，放到6、7、9所在的节点中，注意顺序，现在6、7、8、9这4个数据放到一起作为一个节点，必须要对该节点进行拆分，将8作为根节点，将6、7作为8的左孩子，将8、9作为8的右孩子，将8并到4、6、11所在的节点，如图6所示：

![image-20240831123327169](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123327169.png)
...
![image-20240831123549679](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123549679.png)

插入10，放到8、9所在的节点中，注意顺序，现在8、9、10在一个节点中，如图8所示：

![image-20240831123600902](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123600902.png)
...
![image-20240831123617451](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123617451.png)
...
![image-20240831123905988](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123905988.png)
...
![image-20240831123920243](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123920243.png)
...
![image-20240831123932418](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831123932418.png)

![image-20240831124241112](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831124241112.png)

合并时注意的是因为18在叶子节点中已经不是最左侧的数值，不应该出现在非叶子节点中，因此父节点中应该将18删除，新的父节点是20、30、50。

再看一看图14这棵3阶B+树，现在要删除数据29：

![image-20240831124253013](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831124253013.png)

叶子节点29删除后，所在的节点就没有数据了，此时该节点与24所在节点以及父（29）所在节点就要合并，合并前发现父节点也包含29，将这个29删除。如图15所示：

![image-20240831124306407](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831124306407.png)

合并之后子节点仍旧只有数据24，父节点依旧为空，如图16所示：

![image-20240831124317887](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831124317887.png)

如图16，因为此时父节点（节点24的父亲）为空，不满足3阶B+树节点数据最少为1的情形，所以该父节点和其左兄弟22以及该父节点的父节点24要继续合并。合并后如图17所示：

![image-20240831124327609](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831124327609.png)

此时22、24合并为一个新节点，但该新节点的父亲又为空节点，所以这个空节点要继续与其右兄弟节点42和其父节点36合并，如图18所示：

![image-20240831124338101](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831124338101.png)

合并后如图19所示：

![image-20240831124347953](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831124347953.png)

此时36、42合并为一个新节点，但该新节点的父亲又为空节点，而该空节点恰恰是根节点，所以只需要把这个空的根节点删除，让36、42所在的节点作为整棵B+树的根节点即可，如图20所示：

![image-20240831124359905](https://raw.githubusercontent.com/qhbsss/Pictures/main/Blog_Picturesimage-20240831124359905.png)
